...
public class GalleryM extends Gallery {
	...
	public GalleryM(Context context) {
		super(context);
		mCamera = new Camera();
		this.setStaticTransformationsEnabled(true);
	}

	public GalleryM(Context context, AttributeSet attrs) {
		super(context, attrs);
		mCamera = new Camera();
	...
	public GalleryM(Context context, AttributeSet attrs, int defStyle) {
