 ...
 * @date 2015-8-6
 */
public class CustomScrollView_pc extends ScrollView {
	...
	public CustomScrollView_pc(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	class YScrollDetector extends SimpleOnGestureListener {
	    ...
	    public void notifyStateChange(Boolean b1) {
