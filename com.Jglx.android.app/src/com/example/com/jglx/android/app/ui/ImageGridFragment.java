...
import com.example.com.jglx.android.app.BuildConfig;
import com.example.com.jglx.android.app.R;
import com.example.com.jglx.android.app.common.Utils;
import com.example.com.jglx.android.app.info.VideoEntity;
import com.example.com.jglx.android.app.util.video.ImageCache;
import com.example.com.jglx.android.app.util.video.ImageResizer;
import com.example.com.jglx.android.app.view.RecyclingImageView;
	...
	public void onItemClick(AdapterView<?> parent, View v, final int position, long id) {
		...
		if(position==0)
		{
			...
			if (vEntty.size > 1024 * 1024 * 10) {
				Toast.makeText(getActivity(), "限制大小不能超过10M", Toast.LENGTH_SHORT).show();
				return;
			}
