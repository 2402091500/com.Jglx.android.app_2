...
public class RecorderVideoActivity extends BaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setActiviyContextView(R.layout.activity_recorder);
		setTitleTextRightText("", "录制视频", "", true);
	...
	private void showFailDialog() {
		new AlertDialog.Builder(this).setTitle("提交").setMessage("打开失败")
	...
	private void showNoSDCardDialog() {
		new AlertDialog.Builder(this).setTitle("提交").setMessage("No sd card!")
				.setPositiveButton("确定", new DialogInterface.OnClickListener() {
