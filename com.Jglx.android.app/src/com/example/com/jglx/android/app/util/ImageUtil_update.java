...
public class ImageUtil_update {
	...
	private Bitmap getimage_(String srcPath) {  
	...
	public static Bitmap compressImage(String path) {
		...
		while (baos.toByteArray().length / 1024 > 100) { // 循环判断如果压缩后图片是否大于100kb,大于继续压缩
			...
			System.out.println("图片压缩之后的大小1："+baos.toByteArray().length/1024);
		}
		System.out.println("图片压缩之后的大小2："+baos.toByteArray().length/1024);
